...
- JDK: Briar headless is quite specific about the JDK versions it is compatible with, so I made the decision to bundle it with the app. Downside: bloat. Upside: easier install.
